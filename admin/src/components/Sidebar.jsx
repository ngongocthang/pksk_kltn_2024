...
const Sidebar = () => {
  ...
  return (
    <div className="flex justify-between">
      <div className="min-h-screen bg-[#3f4d67] border-r relative md:w-[300px] w-[47px]">
        {" "}
        {/* Đặt độ rộng cố định trên desktop */}
        {/* Mobile Menu Button */}
        <button
        ...
        {aToken && (
          <ul
            className={`text-white mt-5 transition-all duration-500 ease-in-out ${
              isMobileMenuOpen ? "block" : "hidden md:block"
            }`}
          >
            <NavLink
              className={({ isActive }) =>
                `flex items-center gap-3 py-3.5 px-3 md:px-9 md:min-w-72 hover:bg-[#4fc2] cursor-pointer ${
                  isActive ? "bg-[#4fc2f8] border-r-4 border-primary" : ""
                }`
              }
              to={"/admin-dashboard"}
            >
        ...
        {dToken && (
          ...
          >
            <NavLink
              className={({ isActive }) =>
                `flex items-center gap-3 py-3.5 px-3 md:px-9 md:min-w-72 hover:bg-[#4fc2] cursor-pointer ${
                  isActive ? "bg-[#4fc2f8] border-r-4 border-[#0091a1]" : ""
                }`
              }
              to={"/doctor-dashboard"}
            >
            ...
            >
              <img
                className="filter brightness-0 invert w-6 h-[23px]"
                src={assets.appointments_icon1}
                alt=""
                width="24"
                height="23"
              />
